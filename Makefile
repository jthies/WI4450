...
default: run_tests.x main_cg_poisson.x main_benchmarks.x main_time_integration.x main_gmres_time_integration.x
...
MAIN_TI=main_time_integration.o time_integration.o gmres_method.o operations.o timer.o
...
main_time_integration.x: ${MAIN_TI} 
	${CXX} ${CXX_FLAGS} ${DEFS} -o main_time_integration.x $^

main_gmres_time_integration.x: ${MAIN_TI_GMRES} 
	${CXX} ${CXX_FLAGS} ${DEFS} -o main_gmres_time_integration.x $^
